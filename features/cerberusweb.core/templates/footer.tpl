...
<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
	<tr>
		<td valign="top">
			...
			<b>Cerb</b>&trade;, Devblocks&trade;, Apptendant&trade; &copy; 2002-2013, Webgroup Media LLC - fix/6.3 Version {$smarty.const.APP_VERSION} (Build {$smarty.const.APP_BUILD}) 
			<br>
