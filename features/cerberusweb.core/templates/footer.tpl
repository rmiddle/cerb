...
<table align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
    <tr>
      <td valign="top">
      	...
      	<b>Cerb6</b>&trade;, Cerberus Helpdesk&trade;, Devblocks&trade;, Apptendant&trade; &copy; 2002-2012, WebGroup Media LLC - internal/master Version {$smarty.const.APP_VERSION} (Build {$smarty.const.APP_BUILD}) 
      	<br>
